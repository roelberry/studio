...
export const metadata: Metadata = {
  title: 'About | Indiana Artivist Directory',
};
    ...
    <div className="max-w-4xl mx-auto">
      <Card>
        ...
        <CardContent className="space-y-6 text-lg text-foreground/80">
          <p>
            The Indiana Artivist Directory is a curated, shareable webpage designed to showcase and promote Indiana-based art activists.
          </p>
